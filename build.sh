...
KERVER=$(make kernelversion)
        ...
        if [ -f "$IMG" ]; then
                ...
                tg_post_msg "<b>=============================</b> %0A <b>× Prototype For Redmi 4 Prime ×</b> %0A <b>=============================</b> %0A%0A <b>Date : </b> <code>$(TZ=ID/JKT date)</code> %0A%0A <b>Device Code Name:</b> <code>$CODENAME</code> %0A%0A <b>Kernel Version :</b> <code>$KERVER</code> %0A%0A <b>Developer:</b> @mozzaru86 %0A%0A <b>Support group:</b> t.me/Cooking_kernel_bot %0A%0A <b>Channel:</b> t.me/Cooking_kernel_bot %0A%0A <b>Changelog:</b> %0A https://github.com/mozzaru/android_kernel_xiaomi_markw_new/commits/test_T %0A%0A <b>Download Normal version:</b> %0A https://t.me/Cooking_kernel_bot/ %0A%0A <b>Download Overclock version:</b> %0A https://t.me/Cooking_kernel_bot/ #prototypekernel #markw" "$CHATID"
